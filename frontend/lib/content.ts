...
export const FORM = {
  ...
  errorRateLimit:
    'Слишком много попыток. Пожалуйста, подождите минуту и попробуйте снова.',
  errorServer:
    'Что-то пошло не так на нашей стороне. Напишите нам напрямую — мы обязательно свяжемся.',
} as const
